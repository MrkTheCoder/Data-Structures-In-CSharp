...
namespace LinkedArrayDataStructure
{
    ...
    {
        #region [STEP 1]
        public Node<TType>? Head { get; private set; } // Head should be private, but for Unit Testing purpose we defined like this.
        public Node<TType>? Tail { get; private set; } // Tail should be private, but for Unit Testing purpose we defined like this.
