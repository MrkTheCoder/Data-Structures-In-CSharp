...
namespace LinkedListUnitTests
{
    public class LinkedListTests
    {
        ...
        [Fact]
        public void AddLast_AddFirstNode_HeadAndTailWillPointToSameNodeAndSizeSetToOne()
        {
            // Arrange
            var totalItems = 1;
            var item = 10;
        ...
        [Fact]
        public void AddLast_AddSecondNode_HeadNextSetToNewNodeTailSetToLastNodeAndSizeSetToTwo()
        {
            // ========= Arrange
            var totalItems = 2;
            var item1 = 10;
